...
{
	hittable_list world;
	auto ground_material = make_shared<check_texture>(0.32, color(.2, .3, .1), color(.9, .9, .9));
...
void two_spheres() {
	...
	auto checker = make_shared<check_texture>(0.8, color(.2, .3, .1), color(.9, .9, .9));
