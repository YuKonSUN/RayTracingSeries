...
////		v = cross(w, u);
////		
////		camera_orign = lookfrom;
////		horizontal = focus_dist * viewport_width * u;
////		vertical = focus_dist * viewport_height * v;
////		viewport_lower_left_corner = camera_orign - horizontal / 2 - vertical / 2
////			- focus_dist * w;
...
////		return ray(camera_orign + offset, viewport_lower_left_corner + s * horizontal + t * vertical - camera_orign - offset, ray_time);
////	}
////private:
////	point3 camera_orign;
////	vec3 horizontal;
////	vec3 vertical;
////	point3 viewport_lower_left_corner;
////	vec3 w, u, v;
////	double lens_radius;
////};
//
